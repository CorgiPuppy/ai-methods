...
Для анализа значимых переменных была построена матрица корреляций (см. Рис. 1).

#figure(
  image("../lab1/assets/heatmap.png", width: 80%),
  caption: [Матрица корреляций признаков бриллиантов],
) <fig-heatmap>

== Сравнение моделей
На основе проведенных расчетов были получены графики обучения многослойного перцептрона.

#figure(
  image("../lab1/assets/training_plot.png", width: 80%),
  caption: [График изменения ошибки MSE в процессе обучения],
)
